...
async function main() {
  console.log('🌱 Starting DEVELOPMENT simplified database seed...')
  ...
  // Create demo manager (DEVELOPMENT ONLY)
  const managerPassword = await bcrypt.hash('demo_manager_123', 10)
