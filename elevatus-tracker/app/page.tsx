      ...
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span className="block text-primary-600">Elevatus Employee Tracker</span>
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/employee/login"
              className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-primary-700 bg-primary-100 hover:bg-primary-200 md:py-4 md:text-lg md:px-10 transition-colors"
            >
              Employee Portal
            </Link>
          </div>
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Real-time attendance monitoring with BCEA-compliant leave management and overtime calculations.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Performance Reviews</h3>
                  <p className="mt-5 text-base text-gray-500">
