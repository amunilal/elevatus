      ...
      <div className="px-8 py-8">
        ...
        {savedNotes.length > 0 && (
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {savedNotes.map((note) => (
                <div key={note.id} className="float-left clear-left">
                  <div className="bg-white border border-brand-middle/20 rounded-2xl p-4 group relative inline-block">
                    ...
                    <button
                      ...
                      className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity text-secondary-400 hover:text-red-500"
