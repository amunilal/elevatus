  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/auth/reset-password', {
        ...
        body: JSON.stringify({ token, password, userType: 'EMPLOYER' })
      })
          ...
          <CardContent className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center space-y-3">
                <Link href="/employer/login" className="flex items-center justify-center text-sm font-medium text-brand-middle hover:text-hover-magenta transition-colors">
